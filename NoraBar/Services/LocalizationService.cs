        ...
        private static readonly IReadOnlyDictionary<AppLanguage, IReadOnlyDictionary<LocalizationKey, string>> Translations =
            new Dictionary<AppLanguage, IReadOnlyDictionary<LocalizationKey, string>>
            {
                [AppLanguage.Japanese] = new Dictionary<LocalizationKey, string>
                {
                    ...
                    [LocalizationKey.LauncherHudName] = "ランチャーHUD",
                    ...
                    [LocalizationKey.WorldClocksDescription] = "最大3つの表示名とWindowsタイムゾーンを設定・並び替えします。",
                    [LocalizationKey.ClockLabel] = "表示名",
                    [LocalizationKey.WorldClockLabelHint] = "表示名（例: NYC、LON）",
                    [LocalizationKey.TimeZone] = "タイムゾーン",
                    [LocalizationKey.AddClockButton] = "+ タイムゾーンを追加",
                    [LocalizationKey.RemoveWorldClock] = "世界時計を削除",
                    ...
                    [LocalizationKey.MediaPrevious] = "前へ",
                    [LocalizationKey.MediaPlay] = "再生",
                    [LocalizationKey.MediaPause] = "一時停止",
                    [LocalizationKey.MediaNext] = "次へ",
                    [LocalizationKey.MoveUp] = "上へ移動",
                    [LocalizationKey.MoveDown] = "下へ移動",
                    [LocalizationKey.RemoveWidget] = "ウィジェットを削除",
                    [LocalizationKey.NoMediaPlaying] = "再生中のメディアはありません",
                    ...
                    [LocalizationKey.WidgetWorldClock] = "世界時計",
                    [LocalizationKey.WidgetWorldClockList] = "世界時計",
                ...
                [AppLanguage.English] = new Dictionary<LocalizationKey, string>
                {
                    ...
                    [LocalizationKey.LauncherHudName] = "Launcher HUD",
                    ...
                    [LocalizationKey.WorldClocksDescription] = "Configure up to 3 labels, Windows time zones, and order.",
                    [LocalizationKey.ClockLabel] = "Label",
                    [LocalizationKey.WorldClockLabelHint] = "Clock label (e.g. NYC, LON)",
                    [LocalizationKey.TimeZone] = "Time zone",
                    [LocalizationKey.AddClockButton] = "+ Add Timezone",
                    [LocalizationKey.RemoveWorldClock] = "Remove world clock",
                    ...
                    [LocalizationKey.MediaPrevious] = "Previous",
                    [LocalizationKey.MediaPlay] = "Play",
                    [LocalizationKey.MediaPause] = "Pause",
                    [LocalizationKey.MediaNext] = "Next",
                    [LocalizationKey.MoveUp] = "Move up",
                    [LocalizationKey.MoveDown] = "Move down",
                    [LocalizationKey.RemoveWidget] = "Remove widget",
                    [LocalizationKey.NoMediaPlaying] = "No media playing",
                    ...
                    [LocalizationKey.WidgetWorldClock] = "World Clock",
                    [LocalizationKey.WidgetWorldClockList] = "World Clock",
