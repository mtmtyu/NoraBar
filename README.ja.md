...
NoraBar は Windows デスクトップ向けの WPF アプリケーションです。普段は画面上端に 2px の細いエリアとして静かに待機し、マウスを近づけると開きます。音楽操作に集中した音楽 HUD と、必要な情報を一覧できるホーム HUD を、作業場所の上端から離れずに切り替えられます。
...
- **ホーム HUD**
  - ローカル時刻、日付、設定可能な2つのワールドクロック、再生中メディア、再生操作をまとめて表示します。
  - Activity Modules、Classic System Overlay、Fusion Balanced、Fusion Expressive の4デザインを選べます。
